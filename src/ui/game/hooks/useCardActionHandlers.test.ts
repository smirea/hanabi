...
const TWO_PLAYER_MULTICOLOR_DECK: TestCardSeed[] = [
  { suit: 'R', number: 1 }, { suit: 'M', number: 1 },
  { suit: 'Y', number: 1 }, { suit: 'R', number: 2 },
  { suit: 'G', number: 1 }, { suit: 'Y', number: 2 },
  { suit: 'B', number: 1 }, { suit: 'G', number: 2 },
  { suit: 'W', number: 1 }, { suit: 'B', number: 2 }
];
